    ...
    public void refreshFinish(boolean isSuccess) {
        ...
        if (showRefreshResultEnable) {
            if (isSuccess) { // 刷新成功
                ...
                Drawable drawable = getResources().getDrawable(R.drawable.icon_refresh_succeed);
                ...
                Drawable drawable = getResources().getDrawable(R.drawable.icon_refresh_failed);
                refreshHintText.setCompoundDrawablesWithIntrinsicBounds(drawable, null, null, null);
                refreshHintText.setCompoundDrawablePadding(dp2px(10));
            }
        }
    ...
    public void loadMoreFinish(boolean isSuccess) {
        ...
        if (showRefreshResultEnable) {
            if (isSuccess) { // 加载更多成功
                ...
                Drawable drawable = getResources().getDrawable(R.drawable.icon_load_succeed);
                ...
                Drawable drawable = getResources().getDrawable(R.drawable.icon_load_failed);
                loadHintText.setCompoundDrawablesWithIntrinsicBounds(drawable, null, null, null);
                loadHintText.setCompoundDrawablePadding(dp2px(10));
            }
        }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        switch (ev.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                break;
            case MotionEvent.ACTION_MOVE:
                if (Math.abs(ev.getRawX() - mDownX) > Math.abs(ev.getRawY() - ev.getRawY())) {
                    return false;
                }
                break;
            case MotionEvent.ACTION_UP:
